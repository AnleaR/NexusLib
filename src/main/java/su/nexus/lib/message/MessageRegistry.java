...
public class MessageRegistry {
	...
	public static void registerDefaults() {
		...
		MessageRegistry.registerTagAdapter(NexusLib.getInstance(), JsonElement.class, e -> e);
		MessageRegistry.registerTagAdapter(NexusLib.getInstance(), Number.class, ((Gson) GsonUtil.GSON)::toJsonTree);
		MessageRegistry.registerTagAdapter(NexusLib.getInstance(), String.class, ((Gson) GsonUtil.GSON)::toJsonTree);
		MessageRegistry.registerTagAdapter(NexusLib.getInstance(), Message.class, Message::getCompleteValue);
		MessageRegistry.registerTagAdapter(NexusLib.getInstance(), MessageKey.class, e -> e.message().getCompleteValue());
		MessageRegistry.registerPrimitiveTagAdapter(NexusLib.getInstance(), Player.class, OfflinePlayer::getName);
	}
